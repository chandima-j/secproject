...
-- Insert sample users
INSERT INTO users (name, email, role, location, farm_name) VALUES
('Sarah Thompson', 'sarah@greenvalleys.com', 'farmer', 'Sonoma County, CA', 'Green Valley Organic Farm'),
('Michael Chen', 'admin@freshbonds.com', 'admin', NULL, NULL),
('John Doe', 'john@example.com', 'farmer', 'Napa Valley, CA', 'Sunrise Farm')
